import { I as IIIFStore, E as Entities, N as NormalizedEntity, A as AllActions, B as BatchAction, e as ActionFromType, a as RefToNormalized, R as RequestState, P as PaginationState } from './vault-actions-DIpISlMs.cjs';
import { Reference, SpecificResource, Manifest, Collection } from '@iiif/presentation-3';
...
type __vault_EntityRef<Ref extends keyof Entities> = EntityRef<Ref>;
type __vault_GetObjectOptions = GetObjectOptions;
type __vault_GetOptions = GetOptions;
type __vault_Vault = Vault;
declare const __vault_Vault: typeof Vault;
type __vault_VaultOptions = VaultOptions;
declare namespace __vault {
  export { type __vault_EntityRef as EntityRef, type __vault_GetObjectOptions as GetObjectOptions, type __vault_GetOptions as GetOptions, __vault_Vault as Vault, type __vault_VaultOptions as VaultOptions };
}

export { type EntityRef as E, type GetOptions as G, type VaultOptions as V, __vault as _, type GetObjectOptions as a, Vault as b };
